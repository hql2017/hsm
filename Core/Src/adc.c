...
/**
  ...
  */
  void app_in_energe_adc_value(void)
  {
    ...
    {//采集前100us内中间90us(90/1)(90)
      //if(ad2Buff[i]>=ad2Buff[0]&&ad2Buff[i]>546)//4000)//546) //>25mV:546      
      if(i > 9 && i < (pulse_ad_count - 10))
      {   
        sum += ad2Buff[i];
      }             
    } 
    ...
    if (pulse_ad_count > 20) {
      ad2hle[idx] = (unsigned short int)(sum / (pulse_ad_count - 20));
    } else {
